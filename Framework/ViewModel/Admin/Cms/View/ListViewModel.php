...
{    
    ...
    private function formatSection($section)
    {
        ...
        $section['action'] = $this->getViewHelper()->makeLink([
            'href' => '/admin/cms/view/register/?pid=' . $section['nameHash'],
        ...
        if($row['fileSize'] < 0) {
            ...
            $row['action'] = join('', [
                $this->getViewHelper()->makeButtonLink([
                    'href' => '/admin/cms/view/edit/?pid=' . $row['nameHash'],
                    'class' => 'btn-primary btn-circle',
                    'icon' => 'fa-edit',
                ]),
                $this->getViewHelper()->makeButtonLink([
                    'href' => '/admin/cms/view/copy/?pid=' . $row['nameHash'],
                    'class' => 'btn-success btn-circle',
                    'icon' => 'fa-paste',
                ]),
                $this->getViewHelper()->makeButtonLink([
                    'href' => '/admin/cms/view/show/?pid=' . $row['nameHash'],
                    'class' => 'btn-info btn-circle',
                    'icon' => 'fa-info',
                ]),
                $this->getViewHelper()->makeButtonLink([
                    'href' => '/admin/cms/view/delete/?pid=' . $row['nameHash'],
