 ...
 * AdminUsers
 *
 * @ORM\Table(name="users", uniqueConstraints={@ORM\UniqueConstraint(name="uk_login", columns={"login"})})
 * @ORM\Entity(repositoryClass="Framework\Module\Cngo\AdminUser\Entity\Repository\Users")
 */
