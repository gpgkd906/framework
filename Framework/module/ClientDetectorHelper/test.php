<?php
require "ClientDetectorHelper.php";

$Detector = new ClientDetectorHelper;
...
foreach($ua as $userAgent) {
    ...
    print_r([
        "ua" => $userAgent, "isPc" => $Detector->isPc(), "isSp" => $Detector->isSp(), "isMb" => $Detector->isMb(), "isTablet" => $Detector->isTablet(),
        "browsertName" => $Detector->getBrowserName(), "browsertVersion" => $Detector->getBrowserVersion(),
        "OsName" => $Detector->getOsName(), "OsVersion" => $Detector->getOsVersion()
    ]);
}
