...
class categoryTest extends PHPUnit_Framework_TestCase {
    ...
    public static function setUpBeforeClass() {
        ...
        require '/var/www/html/map/server/framework/model/category.model.php';
        self::$model = category_model::connect(array (
  'type' => 'mysql',
  'host' => 'localhost',
  'user' => 'root',
  'password' => '',
  ...
  'charset' => 'utf8',
    ...
    public static function tearDownAfterClass() {
        category_model::disconnect();
    }

    public function testMap_category() {
